 ...
 */
    ...
    public void put02(){
        ...
        DummyApiDataPojo expectedData = new DummyApiDataPojo("Tom Hanks", 111111, 111111, "Perfect image" );
        ...
        assertEquals(expectedData.getEmployee_age(), actualData.getData().getEmployee_salary());
